...
class AllParametersTab(QWidget):
    ...
    def load_all_parameters_display(self):
        ...
        self.sc_fx_rov.setText(str(calc_params.get('sc_fx_rov', '')))
        self.sc_fy_rov.setText(str(calc_params.get('sc_fy_rov', '')))
    ...
    def save_all_parameters_from_display(self):
        ...
        try:
            ...
            self.main_window.calc_params = {
                ...
                'sc_fx_rov': (self.sc_fx_rov.text() or "").strip(),
                'sc_fy_rov': (self.sc_fy_rov.text() or "").strip(),
