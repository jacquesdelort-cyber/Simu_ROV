...
class SimulationTab(QWidget):
    ...
    def create_control_panel(self):
        ...
        self.dl_dt_mode_btn = QPushButton("Scen")
        self.dl_dt_mode_btn.setCheckable(True)
        self.dl_dt_mode_btn.setChecked(False)
    ...
    def create_visualization_panel(self):
        ...
        fig_dl_dt = create_dl_dt_plot([], [], "Commande dL/dt")
    ...
    def create_metrics_panel(self):
        ...
        # 5. Tension bateau
        metrics_layout.addWidget(QLabel("<b>Tension bateau:</b>"), 6, 0)
        self.tension_boat_label = QLabel("0.00 N")
        metrics_layout.addWidget(self.tension_boat_label, 6, 1)
        
        # 6. Tension ROV
        metrics_layout.addWidget(QLabel("<b>Tension ROV:</b>"), 7, 0)
        self.tension_rov_label = QLabel("0.00 N")
        metrics_layout.addWidget(self.tension_rov_label, 7, 1)
        
        # 7. Tension max
        metrics_layout.addWidget(QLabel("<b>Tension max:</b>"), 8, 0)
        self.tension_label = QLabel("0.00 N")
        metrics_layout.addWidget(self.tension_label, 8, 1)
        
        # 8. Direction câble (Bateau)
        metrics_layout.addWidget(QLabel("<b>Direction câble (Bateau):</b>"), 9, 0)
        self.cable_dir_boat_label = QLabel("(0.00, 0.00)")
        metrics_layout.addWidget(self.cable_dir_boat_label, 9, 1)
        
        # 9. Direction câble (ROV)
        metrics_layout.addWidget(QLabel("<b>Direction câble (ROV):</b>"), 10, 0)
        self.cable_dir_rov_label = QLabel("(0.00, 0.00)")
        metrics_layout.addWidget(self.cable_dir_rov_label, 10, 1)

        # Trait de séparation
        separator_cable_forces = QLabel("─" * 30)
        separator_cable_forces.setStyleSheet("color: #ccc;")
        metrics_layout.addWidget(separator_cable_forces, 11, 0, 1, 2)
        ...
        metrics_layout.addWidget(cable_forces_subtitle, 12, 0, 1, 2)
        
        # 6. Traction bateau sur câble
        metrics_layout.addWidget(QLabel("<b>Traction bateau sur câble:</b>"), 13, 0)
        self.traction_boat_label = QLabel("(0.00, 0.00) N")
        metrics_layout.addWidget(self.traction_boat_label, 13, 1)
        
        # 7. Traction ROV sur câble
        metrics_layout.addWidget(QLabel("<b>Traction ROV sur câble:</b>"), 14, 0)
        self.traction_rov_label = QLabel("(0.00, 0.00) N")
        metrics_layout.addWidget(self.traction_rov_label, 14, 1)
        
        # 8. Poids apparent
        metrics_layout.addWidget(QLabel("<b>Poids apparent:</b>"), 15, 0)
        self.cable_apparent_weight_label = QLabel("(0.00, 0.00) N")
        metrics_layout.addWidget(self.cable_apparent_weight_label, 15, 1)
        
        # 9. Force traînée câble
        metrics_layout.addWidget(QLabel("<b>Force traînée câble:</b>"), 16, 0)
        self.cable_drag_label = QLabel("(0.00, 0.00) N")
        metrics_layout.addWidget(self.cable_drag_label, 16, 1)
        
        # 10. Somme forces câble
        metrics_layout.addWidget(QLabel("<b>Somme forces câble:</b>"), 17, 0)
        self.cable_total_forces_label = QLabel("(0.00, 0.00) N")
        metrics_layout.addWidget(self.cable_total_forces_label, 17, 1)
        
        # Trait de séparation
        separator2 = QLabel("─" * 30)
        separator2.setStyleSheet("color: #ccc;")
        metrics_layout.addWidget(separator2, 18, 0, 1, 2)
        
        # Sous-titre "ROV"
        rov_subtitle = QLabel("<b>ROV</b>")
        rov_subtitle.setStyleSheet("color: #666; font-size: 10pt; margin-top: 5px;")
        metrics_layout.addWidget(rov_subtitle, 19, 0, 1, 2)
        
        # 6. Position ROV
        metrics_layout.addWidget(QLabel("<b>Position ROV:</b>"), 20, 0)
        self.position_label = QLabel("(0.00, 0.00) m")
        metrics_layout.addWidget(self.position_label, 20, 1)
        
        # 7. Vitesse ROV
        metrics_layout.addWidget(QLabel("<b>Vitesse ROV:</b>"), 21, 0)
        self.velocity_label = QLabel("(0.00, 0.00) m/s")
        metrics_layout.addWidget(self.velocity_label, 21, 1)
        
        # Trait de séparation
        separator3 = QLabel("─" * 30)
        separator3.setStyleSheet("color: #ccc;")
        metrics_layout.addWidget(separator3, 22, 0, 1, 2)
        ...
        metrics_layout.addWidget(forces_subtitle, 23, 0, 1, 2)
        
        # Variables de commande (Fx ROV, Fy ROV)
        metrics_layout.addWidget(QLabel("<b>Commande ROV:</b>"), 24, 0)
        self.command_rov_label = QLabel("(0.00, 0.00) N")
        metrics_layout.addWidget(self.command_rov_label, 24, 1)
        
        # Forces de traction du câble sur le ROV
        metrics_layout.addWidget(QLabel("<b>Traction câble sur ROV:</b>"), 25, 0)
        self.traction_cable_label = QLabel("(0.00, 0.00) N")
        metrics_layout.addWidget(self.traction_cable_label, 25, 1)
        
        # 8. Force traînée ROV
        metrics_layout.addWidget(QLabel("<b>Force traînée ROV:</b>"), 26, 0)
        self.drag_label = QLabel("(0.00, 0.00) N")
        metrics_layout.addWidget(self.drag_label, 26, 1)
        
        # 9. Poids apparent
        metrics_layout.addWidget(QLabel("<b>Poids apparent:</b>"), 27, 0)
        self.apparent_weight_label = QLabel("(0.00, 0.00) N")
        metrics_layout.addWidget(self.apparent_weight_label, 27, 1)
        
        # 10. Somme des forces ROV
        metrics_layout.addWidget(QLabel("<b>Somme forces ROV:</b>"), 28, 0)
        self.total_forces_label = QLabel("(0.00, 0.00) N")
        metrics_layout.addWidget(self.total_forces_label, 28, 1)
        
        # Trait de séparation
        separator4 = QLabel("─" * 30)
        separator4.setStyleSheet("color: #ccc;")
        metrics_layout.addWidget(separator4, 29, 0, 1, 2)
        ...
        metrics_layout.addWidget(boat_subtitle, 30, 0, 1, 2)
        
        # Bateau
        metrics_layout.addWidget(QLabel("<b>Bateau:</b>"), 31, 0)
        self.position_boat_label = QLabel("(0.00, 0.00) m")
        metrics_layout.addWidget(self.position_boat_label, 31, 1)
        
        # Vitesse Bateau
        metrics_layout.addWidget(QLabel("<b>Vitesse Bateau:</b>"), 32, 0)
        self.velocity_boat_label = QLabel("(0.00, 0.00) m/s")
        metrics_layout.addWidget(self.velocity_boat_label, 32, 1)
        ...
        if data.get('time'):
            ...
            if data.get('time'):
                try:
                    ...
                    t_rupture_series = [t_rupture] * len(times) if t_rupture is not None else []
                    t_cible_series = [t_cible] * len(times) if t_cible is not None else []
